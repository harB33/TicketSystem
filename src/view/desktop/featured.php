...
<div class="flex flex-col items-center w-full relative min-h-screen bg-black overflow-y-auto custom-scrollbar-v">
    <div class="flex flex-col w-full max-w-2xl min-h-screen">
        <div class="h-[15vh] w-full shrink-0 flex flex-col items-center justify-center bg-black z-20">
        <img src="./asset/logo/featured.png" alt="" class="max-w-96">
    </div>
