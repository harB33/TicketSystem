...
<div class="flex flex-col w-full relative min-h-screen">
    <form method="POST" action="?page=featured" class="w-full flex flex-col min-h-screen">
        ...
        <div class="p-10 fixed bottom-0 bg-linear-to-t from-black via-black/80 to-transparent h-[25%] w-full flex flex-col justify-end items-center z-20 pointer-events-none">
            <button type="submit" name="submit_arenas" class="bg-primary max-w-2xl max-h-13 text-white p-2 rounded-full w-1/2 pointer-events-auto hover:scale-105 active:scale-95 transition">
