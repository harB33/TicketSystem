...
$mobile_passwordStrength = 0;
$mobile_strengthMessage = '';
$mobile_showStrengthBars = false;

function mobile_checkPasswordStrength($password) {
    $strength = 0;
...
if (isset($_POST['email']) && isset($_POST['password']) && isset($_POST['confirm_password'])) {
    ...
    $mobile_passwordStrength = mobile_checkPasswordStrength($password);
    $mobile_showStrengthBars = true;
...
<script>
    ...
    function mobile_updatePasswordStrength() {
        ...
        const strength = mobile_checkPasswordStrength(passwordInput.value);
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (passwordInputField) {
            passwordInputField.addEventListener('input', mobile_updatePasswordStrength);
        }
        ...
        if (form && emailInput && passwordInput && confirmInput) {
            form.addEventListener('submit', function(e) {
                ...
                if (isValid && mobile_checkPasswordStrength(passwordInput.value) < 3) {
                    passwordInput.style.borderColor = '#ef4444';
                    passwordInput.style.boxShadow = '0 0 0 1px #ef4444';
