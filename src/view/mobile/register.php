...
<form action="post" class="flex flex-col h-[50%] w-full justify-center items-center -translate-y-27.5">
    <div class="flex flex-col items-center justify-start h-full w-[80%] gap-4">
        <input type="text" placeholder="email" class="px-6 py-4 rounded-full w-full text-xl font-bold text-[#525252] bg-[#919191]">
        <input type="password" placeholder="password" class="px-6 py-4 rounded-full w-full text-xl font-bold text-[#525252] bg-[#919191]">
        ...
        <input type="password" placeholder="confirm password" class="px-6 py-4 rounded-full w-full text-xl font-bold text-[#525252] bg-[#919191]">
